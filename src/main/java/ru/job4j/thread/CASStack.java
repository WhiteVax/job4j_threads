 ...
 * Но во многих случаях нам нужны действия check-then-act. Чтобы  этого добиться,
 * нужно делать синхронизацию.
 * Синхронизация блокирует выполнение нитей, то есть программа из многопоточной
 ...
 * Это значит если две нити прочитали одно и тоже значение ref, то первый вызов
 * compareAndSet даст true, а второй вызов вернет false.
